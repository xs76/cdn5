function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Shoot_Stickman.loader.js";
		var config = {
        dataUrl: buildUrl + "/Shoot_Stickman.data",
        frameworkUrl: buildUrl + "/Shoot_Stickman.framework.js",
        codeUrl: buildUrl + "/Shoot_Stickman.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Shoot Stickman",
        productVersion: "1",
      };
