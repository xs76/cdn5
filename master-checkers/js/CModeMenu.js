function CModeMenu(){
    ...
    this.refreshButtonPos = function(){
        ...
        if(s_bLandscape){
            ...
            _oButHuman.setPosition(CANVAS_WIDTH/2 - 400, CANVAS_HEIGHT/2 + 100);
            _oButComputer.setPosition(CANVAS_WIDTH/2 + 400, CANVAS_HEIGHT/2 + 100);

            
        }else {
            _oTextHead.y = 400;
            
            _oButHuman.setPosition(CANVAS_WIDTH/2, 800);
            _oButComputer.setPosition(CANVAS_WIDTH/2, 1300);
        }
