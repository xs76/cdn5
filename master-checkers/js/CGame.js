function CGame(oData){
    ...
    this._init = function(){
        ...
        _oDrawContainer.scaleX = _oDrawContainer.scaleY = iScale;
        ...
        _oGridContainer.scaleX = _oGridContainer.scaleY = iScale;
        ...
        _oAnimationContainer.scaleX = _oAnimationContainer.scaleY = iScale;
        s_oStage.addChild(_oAnimationContainer);
        
        _oInterface = new CInterface(_oAnimationContainer);    
        ...
        new CStartAnimation(_oDrawContainer, _aWhitePos, _aBlackPos, _oAnimationContainer);
    ...
    this.refreshButtonPos = function(){
        ...
        var iBoardScale;
        if(s_bLandscape){
            iBoardScale = linearFunction(s_iOffsetY, EDGEBOARD_Y, 0, 0.68, 1.65);
            
        } else {
            iBoardScale = linearFunction(s_iOffsetX, EDGEBOARD_X, 0, 0.94, 2.15);
        ...
        _oDrawContainer.scaleX = _oDrawContainer.scaleY = iBoardScale;
        _oGridContainer.scaleX = _oGridContainer.scaleY = iBoardScale;
        _oAnimationContainer.scaleX = _oAnimationContainer.scaleY = iBoardScale;
    ...
    this.restartGame = function () {
        s_oMain.pokiShowCommercial(s_oGame._restartAfterCommercial);
    };        
    
    this._restartAfterCommercial = function(){
        s_oGame.unload();
        s_oGame._init();
    };      
    ...
    this._activeCellClick = function(){
        ...
        if(_bConstrainedMoves){            
            ...
            if(_oMessage === null){
                _oMessage = new CMessage(_oAnimationContainer, _iCurPlayer, TEXT_JUMP);
            }
