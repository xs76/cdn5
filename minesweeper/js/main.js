...
if (gaenabled == "false") {
  ...
  gascript.setAttribute("src", "/patch/js/null.js?https://www.googletagmanager.com/gtag/js?id=G-WJMM73SFL1");
...
function LoadAds(){
    var ads = document.createElement('script');
     ads.setAttribute("src", "patch/js/null.js?pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5671039626108784"), ads.setAttribute("type", "text/javascript"), ads.setAttribute("crossOrigin", "anonymous"),  ads.onload = function (){
