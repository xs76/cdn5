function CTextButton(iXPos,iYPos,oSprite,szText,szFont,szColor,iFontSize,szAlign,iPaddingX,oParentContainer){
    var _bDisable;
    var _iCurScale;
    var _iWidth;
    var _iHeight;
    ...
    this._init = function(iXPos,iYPos,oSprite,szText,szFont,szColor,iFontSize,szAlign,iPaddingX){
        _bDisable = false;
        _iCurScale = 1;
    ...
    this._init(iXPos,iYPos,oSprite,szText,szFont,szColor,iFontSize,szAlign,iPaddingX);
}